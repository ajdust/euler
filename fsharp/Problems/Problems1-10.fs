...
type IProblem = abstract member Solve : unit -> string
    ...
    let grid =
        let ns =
            [| [| 08;02;22;97;38;15;00;40;00;75;04;05;07;78;52;12;50;77;91;08 |];
               ...
               [| 20;73;35;29;78;31;90;01;74;31;49;71;48;86;81;16;23;57;05;54 |];
               [| 01;70;54;71;83;51;54;69;16;92;33;48;61;43;52;01;89;19;67;48 |]; |]
        in Array2D.init 20 20 (fun i j -> ns.[i].[j])

    let product nums = Seq.fold (fun acc num -> num * acc) 1 nums

    let atOrDefault (g: int[,]) def x y =
        let height = Array2D.length1 g
        let width = Array2D.length2 g
        in if y < height && y >= 0 && x < width && x >= 0 then g.[y,x] else def

    let getLargestAdjacent (g: int[,]) y x =
        let at = atOrDefault g 1
        let right = product [at x y; at (x+1) y; at (x+2) y; at (x+3) y]
        let down = product [at x y; at x (y+1); at x (y+2); at x (y+3)]
        let downright = product [at x y; at (x+1) (y+1); at (x+2) (y+2); at (x+3) (y+3)]
        let downleft = product [at x y; at (x-1) (y+1); at (x-2) (y+2); at (x-3) (y+3)]
        in List.max [ right; down; downright; downleft ]
